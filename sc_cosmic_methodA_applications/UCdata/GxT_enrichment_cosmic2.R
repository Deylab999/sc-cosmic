...
select_cell_types = c("Fibroblast")

enrlist = list()

for(counter1 in 1:length(select_cell_types)){
	tabb_noncausal = read.delim(paste0("/n/groups/price/kushal/Causal/output/ucdata/Noncausal_VIDE_uc_poiss_", select_cell_types[counter1], "_Healthy_Inflamed.txt"))
	
	tabb_causal1 = read.delim(paste0("/n/groups/price/kushal/Causal/output/ucdata/Causal_VIDE_uc_poiss_", select_cell_types[counter1], "_Healthy_Inflamed_propensity_knn.txt"))
	...
	tabb_causal2 = read.delim(paste0("/n/groups/price/kushal/Causal/output/ucdata/Causal_VIDE_uc_poiss_", select_cell_types[counter1], "_Healthy_Inflamed_svd_knn.txt"))
	...
	tabb_causal3 = read.delim(paste0("/n/groups/price/kushal/Causal/output/ucdata/Causal_VIDE_uc_poiss_", select_cell_types[counter1], "_Healthy_Inflamed_propensity_svd_knn.txt"))
	...
	tabb_causal4 = read.delim(paste0("/n/groups/price/kushal/Causal/output/ucdata/Causal_VIDE_uc_poiss_", select_cell_types[counter1], "_Healthy_Inflamed_svd_knn_smooth.txt"))
	...
	tabb_causal5 = read.delim(paste0("/n/groups/price/kushal/Causal/output/ucdata/Causal_VIDE_uc_poiss_", select_cell_types[counter1], "_Healthy_Inflamed_propensity_svd_knn_smooth.txt"))
